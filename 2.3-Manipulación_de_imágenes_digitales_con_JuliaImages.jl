...
# ╔═╡ 45e160d5-915f-43c9-b9d3-351172e3aa49
arte_pixeles_blanco= [RGB(1, 1, 1)  RGB(1, 1, 1) RGB(1, 1, 1)  RGB(1, 1, 1) RGB(1, 1, 1)  RGB(1, 1, 1) RGB(1, 1, 1)  RGB(1, 1, 1)
...
# ╔═╡ b0d3f796-5622-4acc-be5a-90b42e4c0e3d
arte_pixeles= 
	[RGB(1, 0, 1)  RGB(1, 0, 1) RGB(1, 0, 1)  RGB(1, 0, 1) RGB(1, 0, 1)  RGB(1, 0, 1) RGB(1, 0, 1)  RGB(1, 0, 1)
    RGB(1, 0, 1)  RGB(1, 0, 1) RGB(1, 0.7, 0.7)  RGB(1, 0.7, 0.7) RGB(1, 0.7, 0.7)  RGB(1, 0.7, 0.7) RGB(1, 0, 1)  RGB(1, 0, 1)
    RGB(1, 0, 1)  RGB(1, 0.7, 0.7) RGB(1, 0.7, 0.7)  RGB(1, 0.7, 0.7) RGB(1, 0.7, 0.7)  RGB(1, 0.7, 0.7) RGB(1, 0.7, 0.7)  RGB(1, 0, 1)
    RGB(1, 0, 1)  RGB(1, 0.5, 0.5) RGB(1, 0.7, 0.7)  RGB(0, 0, 0) RGB(1, 0.7, 0.7)  RGB(0, 0, 0) RGB(1, 0.7, 0.7) RGB(1, 0, 1)
	RGB(1, 0.5, 0.5) RGB(1, 0.7, 0.7) RGB(1, 0.7, 0.7)  RGB(0.1, 0, 0.5) RGB(1, 0.7, 0.7)  RGB(0.1, 0, 0.5) RGB(1, 0.7, 0.7)  RGB(1, 0.5, 0.5)
    RGB(1, 0.5, 0.5)  RGB(1, 0.5, 0.5)  RGB(0.8, 0.5, 0.5) RGB(1, 0.7, 0.7) RGB(1, 0.7, 0.7)  RGB(1, 0.7, 0.7) RGB(0.8, 0.5, 0.5)  RGB(1, 0.5, 0.5)
    RGB(1, 0, 1)  RGB(0.2, 0.5, 0.5) RGB(1, 0.5, 0.5)  RGB(1, 0.5, 0.5)  RGB(1, 0.7, 0.7)  RGB(1, 0.7, 0.7) RGB(0.7, 0.5, 0.5)  RGB(1, 0, 1)
	RGB(0, 0.6, 0)  RGB(0.2, 0.5, 0.5) RGB(0.7, 0.5, 0.5)  RGB(0.7, 0.5, 0.5) RGB(0, 0.6, 0)   RGB(0.7, 0.5, 0.5) RGB(0.8, 0.5, 0.5)  RGB(0, 0.6, 0) 
]
